 ...
 * 
 * public _1_Employee() { System.out.println("Contructor");
 * 
 * }
 * 
 * } Execution flow: --------------- 1.The static block executes first because
 * it runs when the Employee class is loaded into memory 2.During the object
 * creation,the instance block executes 1st, followed by contructor
 * 
